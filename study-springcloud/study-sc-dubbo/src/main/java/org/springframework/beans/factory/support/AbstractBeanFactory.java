...
public abstract class AbstractBeanFactory extends FactoryBeanRegistrySupport implements ConfigurableBeanFactory {
	...
	static boolean isAddDubboConfig = true;
	...
	public void addBeanPostProcessor(BeanPostProcessor beanPostProcessor) {
        ...
        if (String.valueOf(beanPostProcessor).contains("ReferenceAnnotationBeanPostProcessor") && isAddDubboConfig){
            isAddDubboConfig = true;
            logger.info(" wy code  ReferenceAnnotationBeanPostProcessor add ");
        }
		// Add to end of list
	...
	public void copyConfigurationFrom(ConfigurableBeanFactory otherFactory) {
		...
		if (otherFactory instanceof AbstractBeanFactory) {
            ...
            for (BeanPostProcessor beanPostProcessor : otherAbstractFactory.beanPostProcessors) {
                if (String.valueOf(beanPostProcessor).contains("ReferenceAnnotationBeanPostProcessor")){
                    //TODO
                    logger.info(" wy code  ReferenceAnnotationBeanPostProcessor addAll ");
                }
            }
