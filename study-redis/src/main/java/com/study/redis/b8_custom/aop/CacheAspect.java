package com.study.redis.b8_custom.aop;

import com.study.redis.b8_custom.annotations.Cache;
...
public class CacheAspect {
    ...
    @Pointcut("@annotation(com.study.redis.b8_custom.annotations.Cache)")
    public void cachePointcuit(){}

    @Around("cachePointcuit()")
